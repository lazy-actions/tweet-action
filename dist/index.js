...
function tweet(message, token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield lib_default()(url, options);
        if (!res.ok) {
            try {
...
function run() {
    return src_awaiter(this, void 0, void 0, function* () {
        ...
        if (!inputs.message) {
            inputs.message = render(inputs.template, inputs.data);
        }
        yield tweet(inputs.message, inputs.twitterToken);
    });
}
